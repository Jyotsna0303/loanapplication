...
public class LoanCalculatorController {
	...
	public ModelAndView processNewLoanApplication(LoanApplication loan)
	{
		...
		URI location = restTemplate.postForLocation("http://loans.joe.com/loanApplication", loan); //this line sends the loan for approval request, which could take up to 24 hours
	...
	//setter methods just for testing purposes
